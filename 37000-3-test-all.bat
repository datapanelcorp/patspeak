...
python pat.py 37000-3-CANOPEN-OUTPUT-PWM-NORMAL-MODE-34.pat
::**********************
...
pause
python pat.py RESET.pat
python pat.py 37000-3-CANOPEN-OUTPUT-PWM-NORMAL-MODE-51.pat
::**********************
...
python pat.py RESET.pat
python pat.py 37000-3-CANOPEN-OUTPUT-SHORT.pat
::**********************
