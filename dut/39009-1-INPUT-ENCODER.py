...
outstr += "\n"
outstr += "Command = 87, Counter_1A_Reset = 1, Counter_3A_Reset = 1, Counter_1A_ON_OFF = 1, Counter_3A_ON_OFF = 1, LowBYTE_Counter_1A_Setpoint = 0, LowBYTE_Counter_3A_Setpoint = 0 : NULL : WAIT = 0.2\n"

outstr += "#clear multiplex\n"
outstr += "Command = 0, Counter_1A_Reset = 0, Counter_3A_Reset = 0, Counter_1A_ON_OFF = 0, Counter_3A_ON_OFF = 0, LowBYTE_Counter_1A_Setpoint = 0, LowBYTE_Counter_3A_Setpoint = 0 : NULL\n"
outstr += "\n"
...
while PortIndex <= MaxPort:
    ...
    outstr += "Command = 87, " + xEnable + " = 1 : NULL : WAIT = 0.2\n"
    outstr += "Command = 0, " + xEnable + " = 0 : NULL\n"
    outstr += "#verify count\n"
    outstr += "NULL : " + xEncoderValue + " = " + str(TheRevCount) + " | 0 | 0.1\n" 
    outstr += "#send counter reset\n"
    outstr += "Command = 87, " + xReset + " = 1 : NULL : WAIT = 0.2\n"
    outstr += "Command = 0, " + xReset + " = 0 : NULL\n"
