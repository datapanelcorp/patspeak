...
UUT_DATANAME = 39009-1-OUTPUT-PWM-NORMAL-MODE-51

#-----setup 39009-----
#configure as Output Digital ON/OFF
Command = 82, MODE1 = 0, MODE2 = 0, Enable_24VDC = 0, ADRaw = 0 : NULL : WAIT = 0.5
Command = 83, MODE1A = 4, MODE1B = 4, MODE2A = 51, MODE2B = 51, MODE3A = 4, MODE3B = 4, MODE4A = 51, MODE4B = 51, MODE5A = 4, MODE5B = 4, MODE6A = 51, MODE6B = 51, MODE7A = 4, MODE7B = 4 : NULL : WAIT = 0.5
...
Command = 84, MODE8A = 51, MODE8B = 51, MODE9A = 4, MODE9B = 4, MODE10A = 51, MODE10B = 51, GLOBAL_KP = 255, GLOBAL_KI =  255 : NULL : WAIT = 0.5
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback2A = 0.7 | 0.15 | 0.5
PWM_CTRL_2A = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback2A = 1.4 | 0.15 | 0.5
PWM_CTRL_2A = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback2A = 2.8 | 0.15 | 0.5
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback2B = 0.7 | 0.15 | 0.5
PWM_CTRL_2B = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback2B = 1.4 | 0.15 | 0.5
PWM_CTRL_2B = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback2B = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback4A = 0.7 | 0.15 | 0.5
PWM_CTRL_4A = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback4A = 1.4 | 0.15 | 0.5
PWM_CTRL_4A = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback4A = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback4B = 0.7 | 0.15 | 0.5
PWM_CTRL_4B = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback4B = 1.4 | 0.15 | 0.5
PWM_CTRL_4B = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback4B = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback6A = 0.7 | 0.15 | 0.5
PWM_CTRL_6A = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback6A = 1.4 | 0.15 | 0.5
PWM_CTRL_6A = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback6A = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback6B = 0.7 | 0.15 | 0.5
PWM_CTRL_6B = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback6B = 1.4 | 0.15 | 0.5
PWM_CTRL_6B = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback6B = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback8A = 0.7 | 0.15 | 0.5
PWM_CTRL_8A = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback8A = 1.4 | 0.15 | 0.5
PWM_CTRL_8A = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback8A = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback8B = 0.7 | 0.15 | 0.5
PWM_CTRL_8B = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback8B = 1.4 | 0.15 | 0.5
PWM_CTRL_8B = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback8B = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback10A = 0.7 | 0.15 | 0.5
PWM_CTRL_10A = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback10A = 1.4 | 0.15 | 0.5
PWM_CTRL_10A = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback10A = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
...
NULL : MeterAmps = 0.7 | 0.15 | 0.5
NULL : Feedback10B = 0.7 | 0.15 | 0.5
PWM_CTRL_10B = 500 : NULL : WAIT = 0.2
NULL : MeterAmps = 1.4 | 0.15 | 0.5
NULL : Feedback10B = 1.4 | 0.15 | 0.5
PWM_CTRL_10B = 1000 : NULL : WAIT = 0.2
NULL : MeterAmps = 2.8 | 0.15 | 0.5
NULL : Feedback10B = 2.8 | 0.15 | 0.5
#switch out load line, switch coil
