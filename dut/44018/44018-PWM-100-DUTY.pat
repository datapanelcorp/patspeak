#44018-1
#Verion 3.0-DIRECT-100
UUT_DBC = 44018-PAT.dbc
UUT_DATANAME = 44018-1-PWM-3.0-DIRECT-100
#-----setup PAT-----
#setup load
...
NULL : PwmOut1Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm1DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut1Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm1DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut1Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
...
NULL : PwmOut2Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm2DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut2Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm2DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut2Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut3Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm3DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut3Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm3DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut3Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut4Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm4DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut4Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm4DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut4Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut5Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm5DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut5Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm5DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut5Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut6Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm6DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut6Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm6DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut6Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut7Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm7DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut7Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm7DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut7Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut8Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm8DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut8Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm8DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut8Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut9Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm9DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut9Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm9DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut9Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut10Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm10DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut10Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm10DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut10Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut11Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm11DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut11Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm11DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut11Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
...
NULL : PwmOut12Current = 1.0 | 0.25 | 0.5
NULL : MeterCurrent = 1.0 | 0.25 | 0.5
# --> Duty: 100% Load: 5000ma
LdCurrentSet = 5000, Pwm12DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut12Current = 5.0 | 0.25 | 0.5
NULL : MeterCurrent = 5.0 | 0.25 | 0.5
# --> Duty: 100% Load: 9000ma
LdCurrentSet = 9000, Pwm12DutyCmd = 100 : NULL : WAIT = 0.5
NULL : PwmOut12Current = 9.0 | 0.25 | 0.5
NULL : MeterCurrent = 9.0 | 0.25 | 0.5
# --> Frequency 125 hz
Command = 220, ParamId = 457, Port1PwmFreq = 125 : NULL : WAIT = 0.1
Command = 0, ParamId = 0, Port1PwmFreq = 0 : NULL : NULL
