...
NULL : sdo[0x5003][1] = 0 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 1000 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 1500 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 2000 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 2500 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 3000 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 3500 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
#verify reading from load
NULL : sdo[0x5003][1] = 4000 | 200 | 0.1
NULL : sdo[0x5001][3] = 1 | 0 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 0 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 1000 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 1500 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 2000 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 2500 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 3000 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 3500 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][2] = 4000 | 200 | 0.1
NULL : sdo[0x5001][3] = 4 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 0 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 1000 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 1500 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 2000 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 2500 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 3000 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 3500 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][3] = 4000 | 200 | 0.1
NULL : sdo[0x5001][3] = 16 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 0 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 1000 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 1500 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 2000 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 2500 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 3000 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 3500 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][4] = 4000 | 200 | 0.1
NULL : sdo[0x5001][3] = 64 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 0 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 1000 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 1500 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 2000 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 2500 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 3000 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 3500 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][5] = 4000 | 200 | 0.1
NULL : sdo[0x5001][4] = 1 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 0 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 1000 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 1500 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 2000 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 2500 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 3000 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 3500 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][6] = 4000 | 200 | 0.1
NULL : sdo[0x5001][4] = 4 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 0 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 1000 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 1500 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 2000 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 2500 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 3000 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 3500 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][7] = 4000 | 200 | 0.1
NULL : sdo[0x5001][4] = 16 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
...
LdCurrentSet = 0: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 0 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 0.0 | 0.1 | 0.1
...
LdCurrentSet = 1000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 1000 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 1.0 | 0.1 | 0.1
...
LdCurrentSet = 1500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 1500 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 1.5 | 0.1 | 0.1
...
LdCurrentSet = 2000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 2000 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 2.0 | 0.1 | 0.1
...
LdCurrentSet = 2500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 2500 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 2.5 | 0.1 | 0.1
...
LdCurrentSet = 3000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 3000 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 3.0 | 0.1 | 0.1
...
LdCurrentSet = 3500: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 3500 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 3.5 | 0.1 | 0.1
...
LdCurrentSet = 4000: NULL : WAIT = 0.1
#verify reading from load
NULL : sdo[0x5003][8] = 4000 | 200 | 0.1
NULL : sdo[0x5001][4] = 64 | 0 | 0.1
NULL : MeterCurrent = 4.0 | 0.1 | 0.1
