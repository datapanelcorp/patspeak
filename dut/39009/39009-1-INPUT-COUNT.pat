...
Command = 83, MODE1A = 8, MODE1B = 8, MODE2A = 1, MODE2B = 1, MODE3A = 8, MODE3B = 8, MODE4A = 1, MODE4B = 1, MODE5A = 1, MODE5B = 1, MODE6A = 1, MODE6B = 1, MODE7A = 1, MODE7B = 1 : NULL : WAIT = 0.5
...
Command = 87, Counter_1A_Reset = 1, Counter_1B_Reset = 1, Counter_1A_ON_OFF = 1, Counter_1B_ON_OFF = 1 : NULL : WAIT = 0.2
#clear multiplex
Command = 0, Counter_1A_Reset = 0, Counter_1B_Reset = 0, Counter_1A_ON_OFF = 0, Counter_1B_ON_OFF = 0 : NULL

#verify count
NULL : Hertz_Count_Input1A = 0 | 0 | 0.1
J0_09_TEST_SUPPLY = 1 : NULL : WAIT = 1
NULL : Input_1A = 1 | 0 | 0.1
