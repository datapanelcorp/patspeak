...
J0_01_3A_LOAD = 0 : NULL : WAIT = 0.1
PwrSetVoltage = 140 : NULL : WAIT = 0.1
J0_09_TEST_SUPPLY = 1 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 14 | 0.100 | 0.2
#switch input to load line
J2_02 = 1 : NULL : WAIT = 0.1
...
#test power supply
NULL : MeterVolts = 5.1 | 0.050 | 1
#test feedback
#transition zone around fault threshold; skip feedback assertion
#set power supply
PwrSetVoltage = 52 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 5.199999999999999 | 0.050 | 1
#test feedback
...
#test power supply
NULL : MeterVolts = 5.299999999999999 | 0.050 | 1
#test feedback
NULL : Port_1A = 0 | 0.1 | 0.1
NULL : Input_1A = 2 | 0.1 | 0.1
NULL : Active_Fault_Code = 5 | 0.1 | 0.1
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_1A from 1 to 32 in 2.0 increments
...
NULL : Input_1A = 0 | 0.1 | 0.1
#set power supply
PwrSetVoltage = 331 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 33.1 | 0.320 | 1
#test feedback
#transition zone around fault threshold; skip feedback assertion
#set power supply
PwrSetVoltage = 332 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 33.2 | 0.320 | 1
#test feedback
#transition zone around fault threshold; skip feedback assertion
#set power supply
PwrSetVoltage = 333 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 33.300000000000004 | 0.320 | 1
#test feedback
NULL : Port_1A = 0 | 0.1 | 0.1
NULL : Input_1A = 2 | 0.1 | 0.1
NULL : Active_Fault_Code = 5 | 0.1 | 0.1
...
#test power supply
NULL : MeterVolts = 33.400000000000006 | 0.320 | 1
#test feedback
NULL : Port_1A = 0 | 0.1 | 0.1
NULL : Input_1A = 2 | 0.1 | 0.1
NULL : Active_Fault_Code = 5 | 0.1 | 0.1
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_1B from 1 to 32 in 2.0 increments

J0_01_3A_LOAD = 0 : NULL : WAIT = 0.1
PwrSetVoltage = 10 : NULL : WAIT = 0.1
J0_09_TEST_SUPPLY = 1 : NULL : WAIT = 0.1
#test power supply
NULL : MeterVolts = 1 | 0.320 | 0.2
#switch input to load line
J2_02 = 1 : NULL : WAIT = 0.1
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_3A from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_3B from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_5A from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_5B from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_7A from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_7B from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_9A from 1 to 32 in 2.0 increments
...
#set power supply and wait
PwrSetVoltage = 10 : NULL : WAIT = 0.1
#Sweep of Port_9B from 1 to 32 in 2.0 increments
