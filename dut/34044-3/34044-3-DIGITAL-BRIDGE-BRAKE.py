...
#global setup
TestName = "34044-3-DIGITAL-BRIDGE-BRAKE"
...
while t <= 15:
    ...
    if(t == 8):
        OutputNameA = "Output5A"
        OutputNameB = "Output5B"
    ...
    if(t == 10):
        OutputNameA = "Output6A"
        OutputNameB = "Output6B"
    ...
    if(t == 12):
        OutputNameA = "Output7A"
        OutputNameB = "Output7B"
    ...
    if(t == 14):
        OutputNameA = "Output8A"
        OutputNameB = "Output8B"
