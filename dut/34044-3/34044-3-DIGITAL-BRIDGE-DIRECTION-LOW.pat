...
UUT_DATANAME = 34044-3-DIGITAL-BRIDGE-DIRECTION-LOW
...
#turn on output
Command = 81, Output1A = 1, BRIDGE1_DIR = 1 : Feedback1A = 3.6 | 0.2 | 0.5
#turn off output
Output1A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output1B = 1, BRIDGE1_DIR = 2 : Feedback1B = 3.6 | 0.2 | 0.5
#turn off output
Output1B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE2_DIR
#turn on output
Command = 81, Output2A = 1, BRIDGE2_DIR = 1 : Feedback2A = 3.6 | 0.2 | 0.5
#turn off output
Output2A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output2B = 1, BRIDGE2_DIR = 2 : Feedback2B = 3.6 | 0.2 | 0.5
#turn off output
Output2B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE3_DIR
#turn on output
Command = 81, Output3A = 1, BRIDGE3_DIR = 1 : Feedback3A = 3.6 | 0.2 | 0.5
#turn off output
Output3A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output3B = 1, BRIDGE3_DIR = 2 : Feedback3B = 3.6 | 0.2 | 0.5
#turn off output
Output3B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE4_DIR
#turn on output
Command = 81, Output4A = 1, BRIDGE4_DIR = 1 : Feedback4A = 3.6 | 0.2 | 0.5
#turn off output
Output4A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output4B = 1, BRIDGE4_DIR = 2 : Feedback4B = 3.6 | 0.2 | 0.5
#turn off output
Output4B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE5_DIR
#turn on output
Command = 81, Output5A = 1, BRIDGE5_DIR = 1 : Feedback5A = 3.6 | 0.2 | 0.5
#turn off output
Output5A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output5B = 1, BRIDGE5_DIR = 2 : Feedback5B = 3.6 | 0.2 | 0.5
#turn off output
Output5B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE6_DIR
#turn on output
Command = 81, Output6A = 1, BRIDGE6_DIR = 1 : Feedback6A = 3.6 | 0.2 | 0.5
#turn off output
Output6A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output6B = 1, BRIDGE6_DIR = 2 : Feedback6B = 3.6 | 0.2 | 0.5
#turn off output
Output6B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE7_DIR
#turn on output
Command = 81, Output7A = 1, BRIDGE7_DIR = 1 : Feedback7A = 3.6 | 0.2 | 0.5
#turn off output
Output7A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output7B = 1, BRIDGE7_DIR = 2 : Feedback7B = 3.6 | 0.2 | 0.5
#turn off output
Output7B = 0 : NULL : WAIT = 1
#prompt user to switch
PAUSE-please verify load connection BRIDGE8_DIR
#turn on output
Command = 81, Output8A = 1, BRIDGE8_DIR = 1 : Feedback8A = 3.6 | 0.2 | 0.5
#turn off output
Output8A = 0 : NULL : WAIT = 1
#turn on output
Command = 81, Output8B = 1, BRIDGE8_DIR = 2 : Feedback8B = 3.6 | 0.2 | 0.5
#turn off output
