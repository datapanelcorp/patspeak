...
#global setup
TestName = "34044-3-DIGITAL-NORMAL"
...
outstr += "Command = 82, Enable_DPLTx = 1, Enable_DPLF1 = 1, Enable_DPLF2 = 1 : NULL\n"
    ...
    if((t == 0)|(t == 4)):
        while i <= 10200:
            ...
            if(i <= 10000):
                ...
                outstr += "NULL : " + FeedbackName + " = " + str(i/1000) + " | 0.25 | 0.1\n" 
        ...
        while i <= 4500:
            ...
            if(i <= 4300):
                outstr += "#verify reading from load\n" 
                outstr += "NULL : " + FeedbackName + " = " + str(i/1000) + " | 0.15 | 0.1\n" 
                outstr += "NULL : " + OutputStatus + " = 1 | 0.01 | 0.1\n" 
                outstr += "NULL : MeterCurrent = " + str(i*0.001) + " | 0.01 | 0.1\n" 
                outstr += "\n"
            else:
