...
NULL : PwmOut1Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm1DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut1Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm1DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut1Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut2Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm2DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut2Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm2DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut2Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut3Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm3DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut3Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm3DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut3Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut4Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm4DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut4Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm4DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut4Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut5Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm5DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut5Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm5DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut5Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut6Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm6DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut6Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm6DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut6Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut7Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm7DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut7Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm7DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut7Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut8Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm8DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut8Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm8DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut8Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut9Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm9DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut9Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm9DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut9Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut10Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm10DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut10Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm10DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut10Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut11Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm11DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut11Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm11DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut11Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
...
NULL : PwmOut12Current = 1.0 | 1.5 | 0.5
NULL : MeterCurrent = 1.0 | 1.5 | 0.5
# --> Duty: 1% Load: 5000ma
LdCurrentSet = 5000, Pwm12DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut12Current = 5.0 | 1.5 | 0.5
NULL : MeterCurrent = 5.0 | 1.5 | 0.5
# --> Duty: 1% Load: 13000ma
LdCurrentSet = 13000, Pwm12DutyCmd = 1 : NULL : WAIT = 0.5
NULL : PwmOut12Current = 13.0 | 1.5 | 0.5
NULL : MeterCurrent = 13.0 | 1.5 | 0.5
# --> Duty: 50% Load: 1000ma
