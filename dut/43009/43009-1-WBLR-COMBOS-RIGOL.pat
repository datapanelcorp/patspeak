#43009-1
#Version 0.1
#WheelBrakeLiningRemaining count-position combination test (Rigol DP800 fixed 1.00V)
UUT_DBC = 43009-560.dbc
UUT_DATANAME = 43009-1-WBLR-COMBOS-RIGOL
...
#keep PAT bench supply path off (Rigol drives test voltage)
...
#force Rigol to known-safe state before routing
PAT dp800/rigol_dp800_set_ch.py --resource TCPIP0::192.168.45.197::INSTR --channel 2 --voltage 0.00 --current 1.000 --output off --settle 0.050 --retries 8 --retry-delay 0.500
...
#route Rigol and set fixed test voltage
J4_01 = 1 : NULL : WAIT = 0.1
PAT dp800/rigol_dp800_set_ch.py --resource TCPIP0::192.168.45.197::INSTR --channel 2 --voltage 1.00 --current 1.000 --output on --settle 0.050 --retries 8 --retry-delay 0.500
NULL : MeterVolts = 1.00 | 0.050 | 0.2

#combo 000/255 active=NONE mode=Type1
J1_01 = 0, J1_02 = 0, J1_03 = 0, J1_04 = 0, J1_05 = 0, J1_06 = 0, J1_07 = 0, J1_08 = 0 : NULL : WAIT = 0.2
NULL : MeterVolts = 1.00 | 0.050 | 0.1
