def WriteCountTest(outstr, SetPointValue, MaxCount, RolloverMode, InterlockMode):
    ...
    while PortIndex <= 1:
        ...
        outstr += "Command = 83, MODE1A = " + InPortMode + ", MODE1B = " + InPortMode + ", MODE2A = " + OutPortMode + ", MODE2B = " + OutPortMode + ", MODE3A = " + InPortMode + ", MODE3B = " + InPortMode + ", MODE4A = " + OutPortMode + ", MODE4B = " + OutPortMode + " : NULL : WAIT = 0.2\n"
        outstr += "Command = 83, MODE5A = " + InPortMode + ", MODE5B = " + InPortMode + ", MODE6A = " + OutPortMode + ", MODE6B = " + OutPortMode + ", MODE7A = " + InPortMode + ", MODE7B = " + InPortMode + " : NULL : WAIT = 0.2\n"
        outstr += "Command = 84, MODE8A = " + OutPortMode + ", MODE8B = " + OutPortMode + ", MODE9A = " + InPortMode + ", MODE9B = " + InPortMode + ", MODE10A = " + OutPortMode + ", MODE10B = " + OutPortMode + ", GLOBAL_KP = 255, GLOBAL_KI = 255 : NULL : WAIT = 0.5\n"
        ...
        outstr += "Command = 0, MODE8A = 0, MODE8B = 0, MODE9A = 0, MODE9B = 0, MODE10A = 0, MODE10B = 0, GLOBAL_KP = 0, GLOBAL_KI = 0 : NULL : WAIT = 0.5\n"
        ...
        outstr += "\n"
        if(PortIndex==0):
            outstr += "Command = 87, Counter_1A_Reset = 1, Counter_1B_Reset = 1, Counter_1A_ON_OFF = 1, Counter_2B_ON_OFF = 1 : NULL : WAIT = 0.2\n"
        if(PortIndex==1):
            outstr += "Command = 87, Counter_1A_Reset = 1, Counter_1B_Reset = 1, Counter_1A_ON_OFF = 1, Counter_2B_ON_OFF = 1 : NULL : WAIT = 0.2\n"
        ...
        outstr += "Command = 0, Counter_7A_Reset = 0, Counter_1B_Reset = 0, Counter_1A_ON_OFF = 0, Counter_1B_ON_OFF = 0 : NULL\n"
        outstr += "\n"
