...
dut_feedback_tolerance      = 3.5 #0.25
meter_feedback_tolerance    = 3.5 #0.25
short_wait_s                = 0.01
wait_time_s                 = 0.5
long_wait_s                 = 0.5
    ...
    for freq in freq_test_points:
        ...
        for duty in duty_cycle_test_points:    
            ...
            for ma in current_ma_test_points:
                ...
                outstr += f"NULL : PwmOut{channel}Current = {current_A:.1f} | {dut_feedback_tolerance} | {wait_time_s}\n"
                outstr += f"NULL : MeterCurrent = {current_A:.1f} | {meter_feedback_tolerance} | {wait_time_s}\n"
